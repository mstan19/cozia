...
const Clearance = () => {
	...
	return (
		<div className="min-h-screen">
			...
			<section className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-4 flex justify-items-center bg-white pt-5 mb-5 gap-x-4 gap-y-4 px-3 m-auto">
