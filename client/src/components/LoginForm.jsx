    ...
    <div className="registerStyle login-form">
      <form onSubmit={onSubmit} className="bg-white p-0 m-0">
        <div className="mb-4">
          ...
          <input className="appearance-none border border-black w-full py-2 px-3 text-black-700 leading-tight " name="email" id="login-email" type="text" onChange={handleInputChange} ></input>
        </div>
        <div className="mb-6">
          <label className="block text-black-700 text-sm mb-2" htmlFor="password">
            PASSWORD:
          </label>
          <input className="appearance-none border border-black w-full py-2 px-3 text-black-700 leading-tight" name="password" id="login-password" type="password" onChange={handleInputChange} ></input>
